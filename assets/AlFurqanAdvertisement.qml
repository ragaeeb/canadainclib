...
Sheet
{
    ...
    Page
    {
        ...
        titleBar: TitleBar
        {
            title: quran ? qsTr("Learn Qu'ran") + Retranslate.onLanguageChanged : qsTr("Learn Arabic!") + Retranslate.onLanguageChanged
        ...
        Container
        {
            ...
            ScrollView
            {
                ...
                WebView
                {
                    ...
                    horizontalAlignment: HorizontalAlignment.Fill
                    verticalAlignment: VerticalAlignment.Fill
                    url: quran ? "http://canadainc.org/hosting/alfurqan/quran_unays.jpg" : "http://canadainc.org/hosting/alfurqan/al_furqan_logo.jpg"
